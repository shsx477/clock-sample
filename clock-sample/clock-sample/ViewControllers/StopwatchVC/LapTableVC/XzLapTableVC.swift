...
class XzLapTableVC: UITableViewController {
    ...
    private static var COLOR_BEST_TEXT: UIColor { Const.CUSTOM_GREEN_3 }
    private static var COLOR_WORST_TEXT: UIColor { Const.CUSTOM_RED_3 }
    ...
    private func addLapTimeInfo() { self.lapTimeInfos.insert(XzLapInfo(textColor: Const.COLOR_TEXT_DEFAULT), at: 0) }
